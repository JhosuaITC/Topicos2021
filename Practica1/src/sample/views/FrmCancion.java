...
public class FrmCancion extends Stage {
    ...
    private void CreateUI() {
        ...
        txtNombre.setText(objcanDAO.getNombre_cancion());
        ...
        txtYear.setText(String.valueOf(objcanDAO.getYear()));
